"""
Utility functions for testing NetBox assets-management Plugin.
...
def post_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        ...
        >>> obj = Assetsmanagement.objects.first()
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Assetsmanagement.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Assetsmanagement': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Assetsmanagement.objects.create(name='Test')
