...
### Release Summary
Initial release of NetBox assets-management Plugin. This is a **minor** release introducing basic functionality for managing assets-management resources in NetBox.

### Added
- Initial plugin structure with Assetsmanagement model
